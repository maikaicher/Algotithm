 ...
 * a StringBuilder
 */
public class MyBase64FileSimple2 {
	...
	public static String binToBase64(String textIn, int bitCount) {
		...
		int padding = (6 - textIn.length() % 6) % 6;  // For padding calculation we need the rest of all input bits divided by 6 ("modulo")
	...
	public static String base64ToBinString(String base64In, int bitCount) {
		...
		for (char c : base64In.toCharArray()) {
			sCodes.append(decoding.get(c)); // access Hashtable for decoding info
		}
